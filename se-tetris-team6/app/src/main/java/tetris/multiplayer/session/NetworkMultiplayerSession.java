...
/**
 * 네트워크 멀티플레이 세션 전용 클래스.
 * 네트워크 멀티플레이어에 필요한 참조(플레이어 모델, 컨트롤러, 핸들러)를 한 군데 묶어 둔 값 객체.
 * UI나 컨트롤러가 동일한 세션을 공유해야 하므로 불변 필드만 노출한다.
 */
public final class NetworkMultiplayerSession {
    ...
    public NetworkMultiplayerSession(PlayerState player1,
                                     PlayerState player2,
